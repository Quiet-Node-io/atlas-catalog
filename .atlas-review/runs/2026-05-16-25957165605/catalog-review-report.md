# 2026-05-16-25957165605 Catalog Discovery Review

- Added discoveries: 328
- Removed/superseded review candidates: 144
...
- `huggingface:Qwen/Qwen3-1.7B` from `huggingface` (https://huggingface.co/api/models?sort=downloads&direction=-1&limit=100)
- `huggingface:jonatasgrosman/wav2vec2-large-xlsr-53-portuguese` from `huggingface` (https://huggingface.co/api/models?sort=downloads&direction=-1&limit=100)
